...

{
  ...
  "imagePrompt": "記事を視覚的に表現する報道写真の英語プロンプトを1文(40語以内)で。photojournalism style、wide composition、no text、no logos、no brand names、no company signage、no identifiable companies、no recognizable real personsを含めること。固有人物・政治家・経営者・有名人・特定企業・特定店舗・企業ロゴ・ブランド商品・社屋・看板・商標が識別できる描写は禁止です。匿名の一般的なインドの工場・港湾・スカイライン・市場・通貨・インフラ・店舗・農地などの場面を描写してください。\n  ライティングと色彩は記事のトーンに合わせて変化させてください:\n  - 成長・拡大・お祭り・消費・文化・農業・市場の話題 → vibrant colors / warm golden hour light / colorful saturated tones\n  - 規制・リスク・地政学・金融市場の慎重な分析 → moody / cool light / muted tones\n  - インフラ・製造業・物流の事実報道 → bright daylight / clean industrial palette\n  毎回同じ薄暗い『dawn』『soft natural lighting』を選ばず、記事ごとに変化をつけること。例(成長・市場):『A wide editorial photograph of a bustling generic Indian street market at midday, vivid saturated colors, anonymous stalls, photojournalism style, no text, no logos, no brand names, no recognizable real persons』、例(規制):『A wide editorial photograph of an empty generic government office corridor in India under cool overcast light, muted tones, photojournalism style, no text, no logos, no recognizable real persons』、例(製造):『A wide editorial photograph of a brightly lit anonymous Indian semiconductor cleanroom under daylight fluorescents, clean industrial palette, photojournalism style, no text, no logos, no brand names, no identifiable companies, no recognizable real persons』"
}`
