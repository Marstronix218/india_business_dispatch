  ...
  return (
    ...
    >
      <div className="p-5 md:p-6">
        ...
        <h2 className="text-lg font-bold text-foreground leading-snug mb-2 group-hover:text-primary transition-colors md:text-xl text-balance">
          {article.title}
        </h2>
        ...
        {article.interpretation && (
          <div className="bg-secondary rounded-md px-3 py-2.5 border-l-2 border-accent">
  ...
  return (
    ...
    >
      <div className="flex-1 min-w-0">
        ...
        <h3 className="text-sm font-bold text-foreground leading-snug mb-1 group-hover:text-primary transition-colors md:text-base">
          {article.title}
        </h3>
        <p className="text-xs text-muted-foreground leading-relaxed line-clamp-2">
          {article.summary}
