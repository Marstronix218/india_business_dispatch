...
export const NEWS_ARTICLES: NewsArticle[] = [
  ...
  },
  {
    ...
    interpretation:
      "日本企業への影響：多言語AI技術は日本企業のインド現地オペレーションにも活用可能。カスタマーサポート、ドキュメント処理、社内コミュニケーションの効率化に寄与。",
  },
  {
    id: "6",
