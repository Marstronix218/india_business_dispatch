...

{
  ...
  "imagePrompt": "記事を視覚的に表現する報道写真の英語プロンプトを1文(30語以内)で。photojournalism style、wide composition、no text、no logos、no recognizable real personsを含めること。固有人物ではなく、インドの工場・港湾・スカイライン・市場・通貨・インフラなどの場面を描写すること。例:『A wide editorial photograph of an Indian semiconductor fabrication facility at dawn, shot in photojournalism style, soft natural lighting, no text, no people』"
}`
